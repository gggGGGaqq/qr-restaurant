...
INSERT INTO menu_items (id, category, name, price, description, image, active) VALUES
  ...
  (7, 'hot', 'Домашние пельмени с бульоном', 9.80, 'Сочные пельмени ручной лепки, прозрачный бульон, зелень и черный перец.', NULL, TRUE),
  (8, 'hot', 'Паста с томатами и базиликом', 11.40, 'Паста аль денте, томатный соус, базилик, чеснок и пармезан.', NULL, TRUE),
  (9, 'grill', 'Лосось на гриле с овощами', 17.20, 'Филе лосося, овощи на гриле, лимон и легкий сливочный соус.', NULL, TRUE),
  (10, 'salad', 'Цезарь с курицей', 9.90, 'Романо, куриное филе, пармезан, сухарики и фирменный соус цезарь.', NULL, TRUE),
  (11, 'salad', 'Салат с киноа и авокадо', 10.80, 'Киноа, авокадо, огурец, томаты, микс зелени и лаймовая заправка.', NULL, TRUE),
  (12, 'dessert', 'Чизкейк с ягодами', 6.90, 'Нежный чизкейк, ягодный соус и свежая мята.', NULL, TRUE),
  (13, 'drink', 'Облепиховый морс', 3.80, 'Яркий домашний морс из облепихи с медом и цитрусом.', NULL, TRUE),
  (14, 'drink', 'Айс-латте с ванилью', 4.20, 'Охлажденный эспрессо, молоко, ванильный сироп и лед.', NULL, TRUE)
ON DUPLICATE KEY UPDATE
